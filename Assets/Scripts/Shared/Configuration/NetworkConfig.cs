namespace Shared.Configuration
{
    ...
    //{
    //    public float TickInterval { get; set; } = 0.01f;    //server only

    //    public float RpcTimeout { get; set; } = 1f;         //shared

    //    public byte MaxPlayers { get; set; } = 16;          //server only / shared

    //    public float PlayerUpdateInterval { get; set; } = 0.02f;    //client only

    //    public string TestNetworkKey { get; set; } = "fortis_connect_test"; //shared
    //}
